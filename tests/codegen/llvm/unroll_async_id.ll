...
entry:
  ...
  %ringbuf_output7 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.1*, i64, i64)*)(i64 %pseudo6, %printf_t.1* %printf_args5, i64 8, i64 0)
  ...
  %ringbuf_output10 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.2*, i64, i64)*)(i64 %pseudo9, %printf_t.2* %printf_args8, i64 8, i64 0)
  ...
  %ringbuf_output13 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.3*, i64, i64)*)(i64 %pseudo12, %printf_t.3* %printf_args11, i64 8, i64 0)
