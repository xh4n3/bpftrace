...
counter_merge:                                    ; preds = %lookup_merge, %entry
  ...
  %if_negative8 = icmp slt i64 %ringbuf_output5, 0
  br i1 %if_negative8, label %event_loss_counter6, label %counter_merge7
...
counter_merge7:                                   ; preds = %lookup_merge14, %counter_merge
  ...
  %if_negative21 = icmp slt i64 %ringbuf_output18, 0
  br i1 %if_negative21, label %event_loss_counter19, label %counter_merge20
...
counter_merge20:                                  ; preds = %lookup_merge27, %counter_merge7
  ...
  %if_negative34 = icmp slt i64 %ringbuf_output31, 0
  br i1 %if_negative34, label %event_loss_counter32, label %counter_merge33
...
counter_merge33:                                  ; preds = %lookup_merge40, %counter_merge20
  ...
  %if_negative47 = icmp slt i64 %ringbuf_output44, 0
  br i1 %if_negative47, label %event_loss_counter45, label %counter_merge46
