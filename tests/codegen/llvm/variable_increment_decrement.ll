...
entry:
  ...
  %ringbuf_output3 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.0*, i64, i64)*)(i64 %pseudo2, %printf_t.0* %printf_args1, i64 16, i64 0)
  ...
  %ringbuf_output6 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.1*, i64, i64)*)(i64 %pseudo5, %printf_t.1* %printf_args4, i64 16, i64 0)
  ...
  %ringbuf_output9 = call i64 inttoptr (i64 130 to i64 (i64, %printf_t.2*, i64, i64)*)(i64 %pseudo8, %printf_t.2* %printf_args7, i64 16, i64 0)
