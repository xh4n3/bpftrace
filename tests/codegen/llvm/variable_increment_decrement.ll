...
counter_merge6:                                   ; preds = %lookup_merge13, %counter_merge
  ...
  %if_negative20 = icmp slt i64 %ringbuf_output17, 0
  br i1 %if_negative20, label %event_loss_counter18, label %counter_merge19
...
counter_merge19:                                  ; preds = %lookup_merge26, %counter_merge6
  ...
  %if_negative33 = icmp slt i64 %ringbuf_output30, 0
  br i1 %if_negative33, label %event_loss_counter31, label %counter_merge32
